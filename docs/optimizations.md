...
| **Bloqueio Logi Download Assistant** | `icacls deny write` nativo no `apply-dewin.ps1` | Impede a injeção do instalador de software da Logitech via Windows Update ao plugar periféricos. | Mouses/Teclados Logitech |
